...
{
    [TestFixture]
    public class ObucaServiceUnitTests
    {
        ObucaService oService;


        [SetUp]
        public void Set()
        {
            oService = new ObucaService(new ObucaFakeRepository());
        }
        ...
        {
            bool result = oService.Remove(new Obuca { ObucaId = 6, Naziv = "Puma", UrlSlike = "data:image/jpeg;base64,", Velicina = 43, Cena = 9000.99, Kolicina = 4, ProdavnicaId = 2 });
